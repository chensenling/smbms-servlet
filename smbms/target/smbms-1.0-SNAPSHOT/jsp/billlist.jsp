      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billList }" varStatus="status">
				<tr>
					...
					<td>
					<span><a class="viewBill" href="javascript:;" billid=${bill.id } billcc=${bill.billCode }>查看</a></span>
					<span><a class="modifyBill" href="javascript:;" billid=${bill.id } billcc=${bill.billCode }>修改</a></span>
					<span><a class="deleteBill" href="javascript:;" billid=${bill.id } billcc=${bill.billCode }>删除</a></span>
					</td>
				</tr>
			</c:forEach>
      </table>

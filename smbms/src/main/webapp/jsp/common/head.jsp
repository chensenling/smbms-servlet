...
<!--头部-->
    <header class="publicHeader">
        <h1>SuperMarketBillManage</h1>
        <div class="publicHeaderR">
            <p><span>尊敬的！</span><span style="color: #fff21b"> ${userSession.userName }</span> , 欢迎你！</p>
            <a href="${pageContext.request.contextPath }/jsp/logout.do">退出</a>
        </div>
    </header>
<!--时间-->
    <section class="publicTime">
        <span id="time">2020年8月25日 11:11  星期二</span>
